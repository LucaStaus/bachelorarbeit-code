...
class UpperBound<V, E>(graph: SimpleGraph<V, E>) : Algo<V, E>(graph) {
                ...
                when (nextAction) {
                    ...
                    NextAction.STAY -> {
                        if (nextI > 0) {
                            ...
                            if (centralities[nextI - 1] - centImprovementSums[nextI] >= bestCentrality) {
                                ...
                                var lb =
                                    centImprovementSums[nextI] - centImprovements[nextI][topImprovementVerts[nextI].last()]
                    ...
                    NextAction.DOWN -> {
                        ...
                        if (spacesLeft > 1) {
                            ...
                            var lb =
                                centImprovementSums[nextI - 1] - centImprovements[nextI - 1][last] - centImprovements[nextI - 1][topImprovementVerts[nextI - 1].last()]
                            ...
                            for (vi in topImprovementVerts[nextI - 1]) {
                                ...
                                centImprovements[nextI][vi] =
                                    curCentrality - calcCombinedCentrality(tempDistances[nextI - 1], distanceMatrix[vi])
                                vertOrder[nextI].add(vi)
                            }
